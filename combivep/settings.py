...
CBV_CENTRAL_TEST_DATA_ROOT   = os.path.join(PROJECT_ROOT, 'combivep/data')
CBV_CENTRAL_TEST_DATASET_DIR = os.path.join(CBV_CENTRAL_TEST_DATA_ROOT, 'dataset')
CBV_CENTRAL_TEST_CBV_DIR     = os.path.join(CBV_CENTRAL_TEST_DATA_ROOT, 'CBV')
