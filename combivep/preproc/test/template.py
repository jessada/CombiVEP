...
class SafePreProcTester(SafeTester):
    """ General template for safe "PreProc" modules testing """
...
class RiskyPreProcTester(RiskyTester):
    """ General template for risky "PreProc" modules testing """
